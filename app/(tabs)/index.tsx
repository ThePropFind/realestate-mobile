...
// 53/47, settled on device. The mock measures closer to 60/40, but at that width
// the facts column had ~112pt for a two-line title and wrapped the chips onto two
// rows; a dead even split gave the photo too little. This is the top of the
// usable range — past ~53 the Verified + property-type chips stop sharing a row.
const FEATURED_IMG_W = Math.round((FEATURED_W - FEATURED_PAD * 2 - 12) * 0.53)
